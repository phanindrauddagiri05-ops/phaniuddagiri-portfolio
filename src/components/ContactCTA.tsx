    ...
    <section id="contact" className="relative bg-[#080F1D] py-16 sm:py-24 text-white overflow-hidden border-t border-slate-800">
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12 items-start">
          ...
          >
            <div className="bg-[#0B1220]/80 border border-slate-800 hover:border-slate-700 rounded-2xl sm:rounded-3xl p-5 sm:p-8 space-y-5 sm:space-y-6 backdrop-blur-md shadow-xl transition-all">
              ...
              <div className="space-y-3.5 sm:space-y-5">
                ...
                <motion.a
                  ...
                  className="flex items-start gap-3.5 p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-900/60 hover:bg-slate-800/80 border border-slate-800/80 hover:border-blue-500/40 transition-all group block shadow-xs hover:shadow-blue-500/10"
                >
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  transition={{ duration: 0.2 }}
                  className="flex items-start gap-3.5 p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-emerald-950/30 hover:bg-emerald-950/60 border border-emerald-500/20 hover:border-emerald-500/50 transition-all group block shadow-xs hover:shadow-emerald-500/10"
                >
                ...
                <motion.div
                  whileHover={{ y: -2 }}
                  transition={{ duration: 0.2 }}
                  className="flex items-start gap-3.5 p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-900/60 border border-slate-800/80"
                >
            ...
            <form className="bg-[#0B1220]/90 border border-slate-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 space-y-4 sm:space-y-5 backdrop-blur-md shadow-2xl relative">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs sm:text-sm text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 cursor-pointer"
                  >
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs sm:text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 resize-none"
                />
              </div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3">
                ...
                <motion.button
                  ...
                  transition={{ duration: 0.2 }}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 shadow-lg shadow-emerald-600/20 transition-all cursor-pointer group"
                >
                  <MessageSquare className="w-4 h-4 text-emerald-200" />
                  <span>Send to WhatsApp</span>
                  <ArrowRight className="w-3.5 h-3.5 ml-auto sm:ml-0 transition-transform group-hover:translate-x-1" />
                </motion.button>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.97, y: 0 }}
                  transition={{ duration: 0.2 }}
                  className="flex-1 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl sm:rounded-2xl text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-[#4F7CFF] to-[#8B5CF6] hover:from-[#3B66FF] hover:to-[#7C3AED] shadow-lg shadow-blue-500/20 transition-all cursor-pointer group"
                >
                  <Mail className="w-4 h-4 text-blue-200" />
                  <span>Send to Email</span>
                  <Send className="w-3.5 h-3.5 ml-auto sm:ml-0 transition-transform group-hover:translate-x-1" />
                </motion.button>
              </div>
